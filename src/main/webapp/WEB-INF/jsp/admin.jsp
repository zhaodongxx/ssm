                ...
                <ul class="nav navbar-nav">
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <!-- User Image -->
                                                <img src='<c:url value="/resources/img/user2-160x160.jpg"></c:url>'
                                                     class="img-circle"
                                                     alt="User Image">
                                            </div>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src='<c:url value="/resources/img/user2-160x160.jpg"></c:url>' class="user-image"
                                 alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src='<c:url value="/resources/img/user2-160x160.jpg"></c:url>' class="img-circle"
                                     alt="User Image">
